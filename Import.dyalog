 (inFail fsw)←{opts}Import(target source);Slash;cands;candLengths;name;File;d;f;e;list;Where;Begins;hideBit;hidden;RightExtn;Files;files;dirs;order;Path;RemDir;paths;Nss;DotSlash;nss;NsExpr;PadThis;Target ⍝ Load items from files in folders
